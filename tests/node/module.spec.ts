...
describe('the wasm module under node', () => {
	...
	it('exports memory, and only the documented surface', () => {
		expect(Object.keys(instance.exports).sort()).toEqual([
			...
			'tiny_encode_cost',
			'tiny_encode_cost_at',
			'tiny_encode_opts_sizeof',
			'tiny_error_name',
			'tiny_face_box_sizeof',
			'tiny_features',
			'tiny_font_axis',
			'tiny_font_axis_count',
			'tiny_font_free',
			'tiny_font_has_glyph',
			'tiny_font_load',
			'tiny_font_metrics',
			'tiny_font_metrics_sizeof',
			'tiny_font_reset_axes',
			'tiny_font_set_add',
			'tiny_font_set_axis',
			'tiny_font_set_init',
			'tiny_font_sizeof',
			...
			'tiny_rgb_to_hsl',
			'tiny_rgb_to_hsv',
			'tiny_text_box_sizeof',
			'tiny_text_line_sizeof',
			'tiny_text_lines',
			'tiny_text_measure',
			'tiny_text_measure_runs',
			'tiny_text_measure_set',
